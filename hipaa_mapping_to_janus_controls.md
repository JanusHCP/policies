...
Below is a list of HIPAA Safeguards and Requirements and the BloomAPI controls in place to meet those.

| **Administrative Controls** HIPAA Rule | BloomAPI Control
--- | ---
